  ...
  <section class="section-login w-full lg:w-[50vw] h-screen flex flex-col justify-center px-6 sm:px-16 md:px-28">
    ...
    <div class="mt-6">
      <a href="{{ route('google.login') }}"
        class="flex items-center justify-center gap-2 w-full p-4 rounded-xl bg-red-500 text-white font-bold hover:bg-red-600 transition">
        <i class='bx bxl-google text-xl'></i> Entrar com Google
      </a>
    </div>
  </section>
</body>
