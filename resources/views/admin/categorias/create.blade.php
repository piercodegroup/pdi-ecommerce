...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Cadastrar Nova Categoria</h1>
        ...
        <div class="bg-white rounded-lg border p-6 mb-6">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <input type="text" name="nome" class="w-full rounded border-gray-300 border p-2" required>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Descrição</label>
                    <textarea name="descricao" rows="3" class="w-full rounded border-gray-300 border p-2"></textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                        ...
                        <div id="image-preview" class="mt-2 hidden">
                            <img id="preview" class="h-32 mx-auto" src="#" alt="Pré-visualização da imagem">
                        </div>
                    </div>
                </div>
            </div>
