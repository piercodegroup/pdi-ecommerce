    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('admin.pedidos.create') }}"
                class="px-4 py-2 bg-green-50 text-green-600 rounded border-green-500 border hover:bg-green-600 hover:text-white hover:border-green-600">
                Novo Pedido
            </a>
            <a href="{{ route('admin.pedidos.relatorio') }}"
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('admin.pedidos.show', $pedido->id) }}"
                                class="border border-gray-200 p-2 px-4 rounded-full text-gray-400 mr-3 hover:bg-gray-700 hover:text-white hover:border-gray-700">Ver</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
